<template>
  <section class="content-info">
    ...
    <h3>How to Play</h3>
    <ul>
      <li>Use keyboard or mouse to control the game.</li>
      <li>Avoid obstacles and try to survive longer.</li>
      <li>The difficulty/speed increases gradually over time.</li>
    </ul>
